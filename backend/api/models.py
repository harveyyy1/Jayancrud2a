...
class Item(models.Model):
    ...
    middle_name = models.CharField(max_length=100, default='gerente')
    last_name = models.CharField(max_length=100, default='jayan')
    date_of_birth = models.DateField(default='2003-06-16')
    ...
    residential_address = models.CharField(max_length=255, default='session road')
    zip_code = models.CharField(max_length=10, default='1000')
    permanent_address = models.CharField(max_length=255, default='session road')
